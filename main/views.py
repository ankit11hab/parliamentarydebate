...
def updatedata(request):
    if request.method=='POST':
        if request.POST.get('contactno1') and request.POST.get('POCname') and request.POST.get('email') and request.POST.get('teamSlots'):
            team=teams()
            ...
            team.save()
            return redirect('/')
        if request.POST.get('name') and request.POST.get('college2') and request.POST.get('contactno3') and request.POST.get('email') :
            ...
            adjudicator.save()
            return redirect('/')
        if request.POST.get('teamName') and request.POST.get('POCname') and request.POST.get('country') and request.POST.get('contactno2') and request.POST.get('email'):
            crossopen=crossOpen()
